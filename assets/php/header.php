<?php
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="./index.php">MiddleMan</a>
	...
	<div class="input-group">
	    ...
	    <span class="btn" type="submit" color="white" onclick="$(&apos;#list&apos;).empty(); search(document.getElementById(&apos;searchBox&apos;).value); $(&apos;#hints&apos;).hide();"><i class="fa fa-search"></i></span>
	<a id="trendingTitle" href="trending.html">Trending</a>
        </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<a href "#" style="color:white;"><i class="fa fa-times" style="color:red;"></i></a> Electronics <br/>
